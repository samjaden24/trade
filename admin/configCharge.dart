...
class _ConfigManagementState extends State<ConfigManagement> {
  ...
  void addOrUpdateCharge() {
    ...
    if (editingCharge != null) {
      ...
      setState(() {
        final index = chargesList.indexOf(chargeData);
        if (index != -1) {
          chargesList[index] = chargeData;
        }
        editingCharge = null; // Clear editing state
      });
    } else {
      // Add new charge
      setState(() {
  ...
  void editCharge(Map<String, dynamic> charge) {
    setState(() {
      editingCharge = {...charge}; // Create a new Map to avoid reference issues
              ...
              child: Column(
                ...
                children: [
                  ...
                  TextFormField(
                    ...
                    initialValue: editingCharge != null
                        ? chargePercentage
                        : null, // Display current value when editing
                    decoration: const InputDecoration(
